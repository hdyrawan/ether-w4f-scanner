...
class TestRealWorldPositives:
    ...
    def test_cloudflare_mapi_welab(self):
        r = _result(
            ips=["104.18.1.79"],
    ...
    def test_tencent_edgeone_aquarius(self):
        r = _result(
            ips=["43.174.196.219"],
            cname=["aquarius.banksaqu.co.id.eo.dnse4.com"],
            headers={"eo-log-uuid": "17946984068454628305"},
        )
        names = [m["vendor"] for m in fingerprint(r)]
        assert "tencent-edgeone" in names

    def test_f5_ts_cookie_banksampoerna(self):
        r = _result(
            ips=["103.124.20.98"],
    ...
    def test_f5_ten_char_ts_cookie(self):
        # 10-hex TS cookie (TSa0cfc1c5027=... form) on mb.ag.co.id
    ...
    def test_google_gfe_bankina(self):
        r = _result(
            ips=["34.36.226.141"],
