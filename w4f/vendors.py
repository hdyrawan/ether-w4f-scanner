...
VENDORS: dict[str, dict] = {
    ...
    "gtm-gslb": {
        ...
        # api-external.mncbank.co.id. The vendor behind a given
    ...
    "haproxy": {
        ...
        # prefix marks a stick cookie). Observed on mbanking.brksyariah.co.id
    ...
    "tencent-edgeone": {
        ...
        # Observed on aquarius.banksaqu.co.id (Bank Saqu, 2026-08-14): CNAME
        # aquarius.banksaqu.co.id.eo.dnse4.com, header `eo-log-uuid`, HTTP 567
